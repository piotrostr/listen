...
pub const RAYDIUM_LIQUIDITY_POOL_V4_PUBKEY: Pubkey =
    pubkey!("675kPX9MHTjS2zt1qfr1NYHuzeLXfQM9H24wFSUt1Mp8");

pub const RAYDIUM_LIQUIDITY_POOL_V4_PUBKEY_TESTNET: Pubkey =
    pubkey!("HWy1jotHpo6UqeQxx49dpYYdQB8wj9Qk9MdxwjLvDHB8");

pub const RAYDIUM_AUTHORITY_V4_PUBKEY: Pubkey =
    pubkey!("5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1");

pub const USDC_TOKEN_PUBKEY: Pubkey =
...
pub const JITO_TIP_PUBKEY: Pubkey =
    pubkey!("Cw8CFyM9FkoMi7K7Crf6HNQqf4uEMzpKw6QNghXLvLkY");

pub const RAYDIUM_AMM_PUBKEY: Pubkey =
    pubkey!("5Q544fKrFoe6tsEbD7S8EmxGTJYAKtTVhAW5Q5pge4j1"); // TODO: dublicate of RAYDIUM_AUTHORITY_V4_PUBKEY
