export const toolCalls = {
  en: {
    ...
    market_open: "Executing market order...",
    get_open_orders: "Checking open orders...",
    deposit_usdc: "Depositing USDC...",
    get_balance_overview: "Checking balances...",
    get_latest_price: "Peeking in the orderbook...",
    get_candlesticks_raw: "Grabbing OHLC data...",
    get_candlesticks_analysis: "Monitoring the situation...",
  },
  zh: {
    get_candlesticks_analysis: "监控情况中...",
    get_candlesticks_raw: "获取OHLC数据中...",
    get_latest_price: "查看最新价格中...",
    get_balance_overview: "检查余额中...",
    deposit_usdc: "存入USDC中...",
    market_open: "市场成交中...",
    get_open_orders: "获取未完成订单中...",
    get_quote: "获取报价中...",
    swap: "兑换中...",
