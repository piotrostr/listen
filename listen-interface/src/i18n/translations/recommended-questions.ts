export const recommendedQuestions = {
  en: {
    im_feeling_lucky_question:
      "Please check the tokens with most volume in the last 15 minutes between the 100-500k market cap. Find the ones that are currently retracing, we are looking for the extension between fib 0.618 and 0.782 to bid",
    im_feeling_lucky_display: "I'm feeling lucky",
    ...
    what_chains_are_supported:
      "What are 'chains' and which chains does Listen support?",
    ...
    learn_about_listen: "Get to know Listen",
  ...
  zh: {
    im_feeling_lucky_question:
      "请检查过去 15 分钟内 100-500k 市值之间交易量最大的代币。找到当前正在回调的代币，我们正在寻找在斐波那契 0.618 和 0.782 之间的延伸，以进行一些购买",
    im_feeling_lucky_display: "我很幸运",
    what_actions_can_you_perform_for_me: "你能执行哪些操作？",
    how_do_pipelines_work_and_what_pipelines_can_you_create_for_me:
      "自动化任务如何运作，你能为我创建哪些自动化任务？",
    what_chains_are_supported: "什么是 '链' 以及 Listen 支持哪些链？",
    what_tokens_have_received_largest_inflows_outflows_in_the_past_days:
      "过去 24 小时资金流入/流出最多的代币有哪些？",
    learn_about_listen: "了解 Listen",
