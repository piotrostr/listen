export const recommendedQuestions = {
  en: {
    im_feeling_lucky_question:
      "Please check the tokens with most volume in the last 1 hour. Find the ones that are currently retracing, we are looking for the extension between fib 0.618 and 0.782 to bid",
  ...
  zh: {
    im_feeling_lucky_question:
      "请检查过去 1 小时内交易量最大的代币。找到当前正在回调的代币，我们正在寻找在斐波那契 0.618 和 0.782 之间的延伸，以进行一些购买",
