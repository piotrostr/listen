...
impl TwitterApi {
    ...
    pub async fn search_tweets(
        ...
        let response = self
            .client
            .request::<SearchResponse>(endpoint, Some(params))
            .await?;
...
mod tests {
    ...
    #[tokio::test]
    async fn twitter_xquik_search_tweets_deserialize() {
        let raw_json = r#"{"tweets":[{"id":"1234567890","text":"Xquik search result","createdAt":"2026-05-16T12:00:00Z","url":"https://x.com/xquikcom/status/1234567890","likeCount":4,"retweetCount":2,"replyCount":1,"quoteCount":0,"viewCount":100,"bookmarkCount":1,"author":{"id":"42","username":"xquikcom","name":"Xquik","verified":true}}],"has_next_page":false,"next_cursor":""}"#;
        ...
        assert_eq!(response.next_cursor, Some(String::new()));
    }
}
